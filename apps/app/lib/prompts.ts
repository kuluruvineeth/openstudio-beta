...
export const RESUME_IMPORTER_SYSTEM_MESSAGE: ChatCompletionMessageParam = {
  role: 'system',
  content: `You are Open Studio Resume, an expert system specialized in analyzing complete resumes and selecting the most relevant content for targeted applications.
