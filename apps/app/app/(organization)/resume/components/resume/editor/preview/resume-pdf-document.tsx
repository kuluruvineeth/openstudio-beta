      ...
      <View style={styles.contactInfo}>
        ...
        {resume.phoneNumber && (
          <>
            ...
            {(resume.websiteUrl || resume.linkedinUrl || resume.githubUrl) && (
              <Text style={styles.bulletSeparator}>•</Text>
            )}
          </>
        )}
        {resume.websiteUrl && (
          <>
            <Link
              src={
                resume.websiteUrl.startsWith('http')
                  ? resume.websiteUrl
                  : `https://${resume.websiteUrl}`
              }
            >
              <Text style={styles.link}>{resume.websiteUrl}</Text>
            </Link>
            {(resume.linkedinUrl || resume.githubUrl) && (
              <Text style={styles.bulletSeparator}>•</Text>
            )}
          </>
        )}
        {resume.linkedinUrl && (
          <>
            <Link
              src={
                resume.linkedinUrl.startsWith('http')
                  ? resume.linkedinUrl
                  : `https://${resume.linkedinUrl}`
              }
            >
              <Text style={styles.link}>{resume.linkedinUrl}</Text>
            </Link>
            {resume.githubUrl && <Text style={styles.bulletSeparator}>•</Text>}
          </>
        )}
        {resume.githubUrl && (
          <Link
            src={
              resume.githubUrl.startsWith('http')
                ? resume.githubUrl
                : `https://${resume.githubUrl}`
            }
          >
            <Text style={styles.link}>{resume.githubUrl}</Text>
          </Link>
        )}
      </View>
    </View>
...
export const ResumePDFDocument = memo(
  function ResumePDFDocument({ resume }: ResumePDFDocumentProps) {
    ...
    const styles = useMemo(
      () => createResumeStyles(resume.documentSettings),
