...
export function BackgroundEffects({
  ...
  return (
    <div
      className={cn(
        'fixed inset-0 z-0 h-[calc(100vh)] overflow-hidden',
        className
      )}
    >
      {/* Base Gradient */}
      ...
      <div
        className={cn(
          'absolute top-1/4 left-1/4 h-96 w-96 animate-float-slow rounded-full blur-3xl',
          isBaseResume
      ...
      <div
        className={cn(
          'absolute right-1/4 bottom-1/4 h-96 w-96 animate-float-slower rounded-full blur-3xl',
          isBaseResume
